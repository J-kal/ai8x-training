...
DEFAULT_MODEL_DIR = '/content/drive/MyDrive/MLonMCU/Models/MAX78000/IP_2MB_PLUS'
...
class StudentModel2MBPlus(nn.Module):
    """
    Slightly wider student (CPM/head at 80). Keeps strides/output heads unchanged.
    """
...
def main():
    ...
    log("=== FLEXIBLE POSE TRAINING (2 MB PLUS STUDENT) ===", log_file)
    ...
    student = StudentModel2MBPlus().to(device)
